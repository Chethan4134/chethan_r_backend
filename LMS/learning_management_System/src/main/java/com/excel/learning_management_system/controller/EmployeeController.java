...
public class EmployeeController {
	...
	public ResponseEntity<EmployeeResponce<String>> postContactInfo(@RequestBody EmployeeContactList dto) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(EmployeeResponce.<String>builder().data(employeeId).message("employee contact details Saved").build());
	}
	...
	public ResponseEntity<EmployeeResponce<String>> postExperienceInfo(@RequestBody EmployeeExperienceList dto) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(EmployeeResponce.<String>builder().data(employeeId).message("employee experience details Saved").build());
	}
